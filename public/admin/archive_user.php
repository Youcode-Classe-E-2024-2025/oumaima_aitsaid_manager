...
$sql = "SELECT * FROM users where is_archifed = 1";
...
<body class="bg-gray-100 font-sans">
    <div class="container mx-auto p-8">
        ...
        <div class="mb-4 text-right">
            <a href="dashbord.php" class="inline-block bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition">dashbord</a>
            <a href="../user/logout.php" onclick="return confirm('Are you sure you want to log out?');">Logout</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="border-t border-gray-200">
                        ...
                        <td class="px-6 py-4 space-x-2">
                            ...
                            <a href="../../modal/restor_user.php?id=<?php echo $row['id']; ?>" class="bg-red-500 text-white py-2 px-4 rounded-md hover:bg-red-600">restor</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
